...
export class ProductList {
    ...
    updateListElem(data = []) {
        ...
        const listItems = data.map((item)=>{
            ...
            listItemElem.innerHTML = this.getHTMLTemplateListItem`
                <article class="goods__card card">
                <a href="/product/1" class="card__link card__link_img">
                  <img class="card__img" src="./public/images/armchair.jpg" alt="Кресло с подлокотниками">
                </a>
                <div class="card__info">
                  <h3 class="card__title"><a href="/product/1" class="card__link">Кресло с подлокотниками</a></h3>
