    ...
    getHTMLTemplateListItem({id, name: title, price, images: [image]}) {
        return `
                ...
                <a href="/product/1" class="card__link card__link_img">
                  <img class="card__img" src="./public/images/armchair.jpg" alt="${title}">
                </a>
                <div class="card__info">
                  <h3 class="card__title"><a href="/product/${id}" class="card__link">${title}</a></h3>
                <p class="card__price">${price.toLocalString()}&nbsp;₽</p>
                </div>
